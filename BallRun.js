...
var ballData = [
            {
                "radius" : 125,
                "cor" : 0.2,
                "image" : "qrc:/icon/ball1.png",
                "mergeImage" : "qrc:/icon/merge2.png",
            },
            {
                "radius" : 115,
                "cor" : 0.3,
                "image" : "qrc:/icon/ball2.png",
                "mergeImage" : "qrc:/icon/merge3.png",
            },
            {
                "radius" : 105,
                "cor" : 0.3,
                "image" : "qrc:/icon/ball3.png",
                "mergeImage" : "qrc:/icon/merge4.png",
            },
            {
                "radius" : 95,
                "cor" : 0.3,
                "image" : "qrc:/icon/ball4.png",
                "mergeImage" : "qrc:/icon/merge5.png",
            },
            {
                "radius" : 80,
                "cor" : 0.3,
                "image" : "qrc:/icon/ball5.png",
                "mergeImage" : "qrc:/icon/merge6.png",
            },
            {
                "radius" : 70,
                "cor" : 0.3,
                "image" : "qrc:/icon/ball6.png",
                "mergeImage" : "qrc:/icon/merge7.png",
            },
            {
                "radius" : 60,
                "cor" : 0.3,
                "image" : "qrc:/icon/ball7.png",
                "mergeImage" : "qrc:/icon/merge8.png",
            },
            {
                "radius" : 50,
                "cor" : 0.3,
                "image" : "qrc:/icon/ball8.png",
                "mergeImage" : "qrc:/icon/merge9.png",
            },
            {
                "radius" : 40,
                "cor" : 0.3,
                "image" : "qrc:/icon/ball9.png",
                "mergeImage" : "qrc:/icon/merge10.png",
            },
            {
                "radius" : 30,
                "cor" : 0.3,
                "image" : "qrc:/icon/ball10.png",
                "mergeImage" : "qrc:/icon/merge11.png",
            },
            {
                "radius" : 20,
                "cor" : 0.1,
                "image" : "qrc:/icon/ball11.png",
                "mergeImage" : "qrc:/icon/merge11.png",
            },
];
...
function getBallData() {
   ...
   if (balls.length < 3)        // 开场前3个都为葡萄
       ...
       return Math.random() < 0.55 ? ballData.length - 1 ://大概控制每种水果生成的概率
...
function collide() {
    ...
    for (let i = 0; i < balls.length; i++)  {
       ...
       for (let j = i + 1; j < balls.length; j++) {
           ...
           if (distance > radius) continue;         //两球种类相同则合成
...
function changeSpeedAndDirection(ball1, ball2, distance, radius) {
    ...
    let ex = dx / radius; let ey = dy / radius;     //法向单位向量（ex,ey）,方向由j指向i
    ...
    let ux = -dy / radius; let uy = dx / radius;    //切向单位向量（ux,uy）,方向为（ex,ey）逆时针旋转n/2
